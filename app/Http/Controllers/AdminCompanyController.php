<?php namespace App\Http\Controllers;
	...
	class AdminCompanyController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Youtube','name'=>'youtube','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Web Title','name'=>'web_title','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Web Description','name'=>'web_description','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Web Icon','name'=>'web_icon','type'=>'upload','validation'=>'required|image|max:3000','width'=>'col-sm-10','help'=>'File types support : JPG, JPEG, PNG, GIF, BMP'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:company","placeholder"=>"Please enter a valid email address"];
