<?php namespace App\Http\Controllers;
	...
	class AdminSliderController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Background Image","name"=>"background_image","image"=>true];
			...
			$this->form[] = ['label'=>'Background Image','name'=>'background_image','type'=>'upload','validation'=>'required|image','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Subtitle','name'=>'subtitle','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Background Image","name"=>"background_image","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
